...
- **Gerard Ros**. Author, maintainer.

- **Sven Verweij**. Author.

- **Job de Pater**. Contributor.

- **Yuki Fujita**. Contributor.

- **Kees van den Dool**. Contributor.

- **Astrid Berndsen**. Contributor.

- **Brent Riechelman**. Contributor.
  [](https://orcid.org/0000-0003-1501-1573)

- **Nutriënten Managment Instituut**. Copyright holder.
